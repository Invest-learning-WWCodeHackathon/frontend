...
export default function WithSubnavigation() {
  ...
  const { username, isAuthorized } = useCurrentUser();
  ...
  const unauthorizedLogin =
    <>
      <Stack
        ...
        <Button as={"a"} display={{ base: "none", md: "inline-flex" }} fontSize={"sm"} fontWeight={600} color={'white'} bg={'blue.400'} href={'sign-up'} _hover={{
          bg: "blue.300",
        }}>
          Sign Up
        </Button>
  ...
  return (
    <Box>
      ...
      >
        ...
        {isAuthorized ? authorizedLogin : unauthorizedLogin}
